...
AddBibsToListModalInstanceController.$inject = ['$scope', 'selectedBibIds', 'bibLists', '$uibModalInstance', 'SweetAlert', 'BibList'];

function AddBibsToListModalInstanceController($scope, selectedBibIds, bibLists, $uibModalInstance, SweetAlert, BibList) {
